...
//import com.chenlb.mmseg4j.NationLetter;
//import com.chenlb.mmseg4j.ReadChar;
//import com.chenlb.mmseg4j.ReadCharByAsciiOrDigit;
//import com.chenlb.mmseg4j.ReadCharByGreece;
//import com.chenlb.mmseg4j.ReadCharByRussia;
//import com.chenlb.mmseg4j.ReadCharByType;
//import com.chenlb.mmseg4j.ReadCharDigit;
...
//					readChars(bufSentence, new ReadCharByType(Character.OTHER_PUNCTUATION));
					bufWord.add(createWord(bufSentence, "punctuation"));
					bufSentence.setLength(0);
					break;
				}//switch
			}
